module labs/service-mesh/locations

go 1.21.4

replace labs/service-mesh/helper => ../helper

require (
	github.com/bytedance/sonic v1.10.2
	github.com/gofiber/fiber/v2 v2.51.0
	github.com/jinzhu/copier v0.4.0
	github.com/opus-domini/fast-shot v0.8.3
	github.com/panjf2000/ants/v2 v2.9.0
	labs/service-mesh/helper v0.0.0-00010101000000-000000000000
)

require (
	github.com/Masterminds/squirrel v1.5.4 // indirect
	github.com/carlmjohnson/deque v0.23.1 // indirect
	github.com/carlmjohnson/flowmatic v0.23.4 // indirect
